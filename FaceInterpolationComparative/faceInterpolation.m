...
for i=1:6
    n_cell = 4^i;
    name = strcat("Center_Line_Temperature_Stationary_Central_Diffencing_Scheme_",num2str(n_cell),".csv");
...
for i=1:6
     n_cell = 4^i;
    name = strcat("Center_Line_Temperature_Stationary_Upwind_Diffencing_Scheme_",num2str(n_cell),".csv");
...
legend(legend_name)
%%
analitic = csvread("Center_Line_Temperature_Stationary_Box_Upwind_Diffencing_Scheme_4096.csv",1);
%%
