...
public:
    ...
    virtual double viscosity(const field::StateVector& state) final {
...
public:
    ...
    virtual double conductivity(const field::StateVector& state) final {
...
public:
    ...
    virtual double specificHeat(const field::StateVector& state) final {
